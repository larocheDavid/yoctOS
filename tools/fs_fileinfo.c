...
static bool display_inode_info(char *filename, FILE *fs) {
...
static void usage(char **argv) {
	...
	fprintf(stderr, "Display a file's meta information (aka inode contents).\n");
	fprintf(stderr, "file: file for which to display meta information.\n");
...
int main(int argc, char* argv[]) {
	...
	if (!display_inode_info(basename(path), fs))
		return EXIT_FAILURE;
